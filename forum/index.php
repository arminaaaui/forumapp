...
<body>
	<?php
	//echo "<body style=\"margin:0; padding:0; background-repeat:no-repeat; background-image:url(images/been.jpg)\">";
	?>
	<!-- Navigation -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="index.php">EBEES FORUM</a>
            </div>
        ...
        <!-- /.container-fluid -->
			...
			<div class="container" style="margin:8% auto;">
				<div class="col-sm-4 col-md-3">
					<h2>Willkommen zum beliebtesten Imker-Forum</h2>
					<p></p>
				</div>
